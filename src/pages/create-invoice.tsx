  ...
  const handleSave = async () => {
    ...
    if (response.status === 200 || response.status === 201) {
      ...
      notification.error({
        ...
        description: 'Please ensure you have selected a client and added items to your invoice',
      });
    }
  }
        ...
        <div className='page invoices-page'>
          ...
          <Form layout='vertical'>
            <Row gutter={16}>
              ...
              <Col span={6}>
                <Form.Item label='Invoice Total'>
                  <h3>{formatToMoneyWithCurrency(getInvoiceTotal())}</h3>
                </Form.Item>
              </Col>
            </Row>
            <Divider />
